    ...
    def activate(self, auto_calibrate: bool = True):
        ...
        if not self.is_active():
            ...
            while (not self._get_var(self.ACT) == 1 or not self._get_var(self.STA) == 3):
                time.sleep(0.01)#nd the gripper will flash red and blue.  I tried reactivating the gripper, restarting the robot, unplugging the gripper and plugging it back in, taking the gripper off and checking the little pins.
